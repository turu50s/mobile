...
if (!preg_match("/^[1-9][0-9]*$/",$_POST['number1'])) {
    ...
    HTTP::redirect("http://www.asa-kashiwa.net/mobile/seibu/au.php?".$sis_id);   
...
・以下の項目に入力後、送信して下さい。<br /><br /> 
   ...
   <font color="red">※</font>お名前：<br>
      <input type="text" name="name"  style="font-size:xx-small" value="<?php print "$name"; ?>" format="*M" accesskey="1" size="20"><br>
　ペンネーム：<br>
      <input type="text" name="pname" style="font-size:xx-small" value="<?php print "$pname"; ?>" format="*M" accesskey="2" size="20"><br>
　年齢：
  <select name="age" style="font-size:xx-small" accesskey="3">
...
?>
  ...
  　町名<select name="town" style="font-size:xx-small" accesskey="4">
  <option value="">選択して下さい</option>
<?php
try {
...
?>
  ...
  　番地
     <input type="text" name="street" style="font-size:xx-small" value="<?php print "$street"; ?>" format="*x" size="20"><br>
  　建物
     <input type="text" name="bilding" style="font-size:xx-small" value="<?php print "$bilding"; ?>" format="*M" size="20"><br>
      <font color="red">※</font>電話：<br>
      <input type="text" name="tel" style="font-size:xx-small" value="<?php print "$tel"; ?>" format="*N" accesskey="5" size="20"><br>
  ※ﾒｰﾙｱﾄﾞﾚｽは、半角で入力して下さい。<br>
   <font color="red">※</font>ﾒｰﾙｱﾄﾞﾚｽ：<br>
      <input type="text" name="email1" style="font-size:xx-small" value="<?php print "$email1"; ?>" format="*x" accesskey="6" size="20">@
   <select name="email2" style="font-size:xx-small">
   <option value="">選択して下さい</option>
<?php   
  try {
    $db = new PDO('sqlite2:../../SQLiteManager-1.2.0/mobile');
...
　コメント：<br>
          <textarea name="comment" cols="20" rows="2" style="font-size:xx-small" format="*M"  accesskey="7"><?php print "$comment"; ?></textarea><br>
          <input type="submit" style="font-size:xx-small" value="確認する">
          
      </form><br /><br />
      <a href="au.php">チケット選択画面へ戻る。</a>
<?php
}
