...
if (!preg_match("/^[1-9][0-9]*$/",$_POST['number1'])) {
    ...
    HTTP::redirect("http://www.asa-kashiwa.net/mobile/masuo/au.php?".$sis_id);   
...
<img src="./life.gif" width="150" height="31" alt="" style="margin:7px 0 7px 0;" />
</div>
<!--ロゴEND-->
...
<?php
    ...
    $title = mb_convert_encoding("【ASAライフ】チケットプレゼント申込",mb_internal_encoding() ,"SJIS-win");
