...
if (!preg_match("/^[1-9][0-9]*$/",$_POST['number1'])) {
    ...
    HTTP::redirect("http://www.asa-kashiwa.net/mobile/chuo/sb.php?".$sis_id);   
...
<img src="./friends.gif" width="178" height="31" alt="" style="margin:7px 0 7px 0;" />
</div>
<!--ロゴEND-->
...
try {
    ...
    $sql = "SELECT * FROM 'address' WHERE tenpo = 'chuo'";
    $rs  = $db->query($sql);
...
<?php
    ...
    $to = "chuo-tk@asa-kashiwa.net";
        
    mb_language("Japanese");
    mb_internal_encoding ("UTF-8");
         
    $title = mb_convert_encoding("【ASAフレンズ】チケットプレゼント申込",mb_internal_encoding() ,"SJIS-win");
